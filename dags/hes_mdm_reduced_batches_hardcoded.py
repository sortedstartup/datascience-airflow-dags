...
@dag(
    dag_id="hes_mdm_reduced_batches_hardcoded",
...
def hes_mdm_reduced_batches_hardcoded():
    ...
    def generate_batches():
        total_meters = 300000   # Hardcoded
        batch_size = 150        # Hardcoded
    ...
    def process_batch_bulk(meter_ids):
        ...
        logging.info(f"[{hostname}] Successfully sent {len(payload)} records to MDM.")
